...
- `docker-compose build`: launch once to generate container (no need to launch it for each changes in application dependencies)
- `docker-compose up`: install application dependencies and launch app in Open [http://localhost:3000](http://localhost:3000) (analogue of `yarn && yarn start`)
